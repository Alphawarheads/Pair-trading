#a replication of the paper Stübinger, Johannes, and Endres, Sylvia. (2018). Pairs trading with a mean-reverting jump-diffusion model on high-frequency data.
#data from jointquant
